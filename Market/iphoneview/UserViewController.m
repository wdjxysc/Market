...
{
    NSLog(@"orderBtnPressed");
}

-(void)couponsBtnPressed
{
    NSLog(@"couponsBtnPressed");
}

-(void)attentionBtnPressed
{
    NSLog(@"attentionBtnPressed");
    MyAttentionViewController *myAttentionViewController = [[MyAttentionViewController alloc] initWithNibName:@"MyAttentionViewController" bundle:nil];
    [self.navigationController pushViewController:myAttentionViewController animated:YES];
}

-(void)massageBtnPressed
{
    NSLog(@"massageBtnPressed");
}

-(void)browseBtnPressed
{
    NSLog(@"browseBtnPressed");
    BrowseHistoryViewController *browseHistoryViewController = [[BrowseHistoryViewController alloc] initWithNibName:@"BrowseHistoryViewController" bundle:nil];
    [self.navigationController pushViewController:browseHistoryViewController animated:YES];
}
@end
